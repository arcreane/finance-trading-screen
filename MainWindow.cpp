...
void MainWindow::setupUi() {
  ...
  menuLayout->addWidget(
      new QLabel("MENU | NEW | TOOLS | WORKSPACES | CONNECTIONS API | HELP"));
  ...
  tickerLayout->addWidget(
      new QLabel("ETH/USDT | DAILY | INDICATORS | Bloomberg News Ticker..."));
  ...
  // Replaced with TradingBottomPanel (Zone 5)
  TradingBottomPanel *bottomPanel = new TradingBottomPanel();
  bottomPanel->setMinimumHeight(150); // Allow resizing, but keep a minimum
